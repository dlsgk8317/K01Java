	...
	public static void main(String[] args) {
		...
		/*
		 상수 : 저장된 값이 변하지 않는 메모리의 한종류
		 	...
		 	- 상수는 딱 한번만 초기화되고, 중간에 값을 변경하면 에러가 발생됨.
		...
		//PI = 3.141592; // 상수의 값은 고정이며, 아래서 값을 바꾸려고 임의로 넣어서 출력하려고해서 에러 -> 상수는 한번 초기화하면 변경불가능.
		
		
		final String NICK_NAME;
		//System.out.println("우리는 "+ NICK_NAME); //상수에 값이 없는데 상수의 값을 출력해서 에러 -> 상수가 초기화되지 않는 상태에서 출력하면 에러발생됨.
		NICK_NAME = "코스모82기";
