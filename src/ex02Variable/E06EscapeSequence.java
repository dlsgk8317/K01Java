...
public class E06EscapeSequence {
	...
	public static void main(String[] args) {
		...
		사용예 ) %4d : 정수 출력시 전체자리수를 4자리로 표현
			%d.2f : 실수 출력시 전체자리수는 6자리, 소수이하 2자리로 표현.
		...
		System.out.printf("국어:%6d, 영어:%6d, 수학:%6d" // 미리 우측으로 6자리를 확보 후 작성
				+ " 평균:%7.2f %n",	kor, eng, math, avg);
		System.out.printf("국어:%-6d, 영어:%-6d, 수학:%-6d" // 미리 좌측으로 6자리를 확보 후 작성
				+ " 평균:%-7.2f %n",	kor, eng, math, avg);
