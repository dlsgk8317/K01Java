...
public class E02SilsuType {
	...
	public static void main(String[] args) {
		...
		/*
		 실수자료형
		 - 정수형보다는 실수형이 더 큰 자료형이다(0과 1사시에 무수한 많은 실수가 존재하기때문)
		...
		/*
		 float와 lont의 연산결과를 long로 받고싶다면
		...
		/*
		 - 실수형에서 기본적은 double 이다.
		 - 소수점이 있는 데이터를 컴파일러는 무조건 double로 인식한다.
		 - 단, 소수점이 없는 데이터는 float에 대입할수있디.
		...
		float f4 =(float)3.14; // 형변환 후 대입이 가능(권장사항은아님)
