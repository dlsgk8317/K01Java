...
public class E01StringBasic {
	...
	public static void main(String[] args) {
		...
		/*
		기본자료형의 경우 비교연산자(==)틀 통해 값에대한 비교를 한다.
		 */
		...
		/*
		str1, str2는 String 객체의 참조값을 가지고있으므로
		아래의 비교는 단순히 참조값(주소값)에 대한 비교를 하게된다.
