...
public class E01OneDimArray01 {
	...
	public static void main(String[] args) {
		...
		/*
		자바에서는 배열을 객체로 통해 생성하게된다.
		생성된 배열은 Heap(힙) 영역에 저장되고, 할당되 메모리의 주소값을 반환한다.
		그래서 배열명(배열변수)는 주소값(참조값)을 할당받게된다. 해당 주소를 통해 배열을 접근한다.
		 */
		...
		System.out.println("배열명(numArr)=" + numArr); // [I@4493d195  = 참조값(주소값)출력
		...
		System.out.println("=========================");
			...
			/*
			배열의 선언과 동시에 초기화를 하는경우 자바 컴파일러는 초기값의 갯수를 통해 크기를 결정할 수 
			있으므로 이런경우 크기는 생략하도록 약속되어있다.
			 */
			...
			/*
			배열 요소의 갯수를 토앻 배열을 즉시 생성한다. 이때 new키워드는 생략할 수있다.
			 */
