	...
	public static void main(String[] args) {
		...
		*/
		...
		시나리오] 90점이상 : A학점
			...
			:점수의 구간같은 경우에는 이상, 이하에 해당하는 두조건을 묶어주는게 안전하다.
		 */
		...
		switch(month) {
		case 3 : case 4: case 5: //if문 or조건 (||)조건같은형식
		...
		문장이 출력되게된다. 따라서 해당 조건에 맞는 출력문을 위해서는 반드시 break을 써줘야한다.
		 */
