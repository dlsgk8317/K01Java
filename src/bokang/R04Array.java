...
public class R04Array {
	...
	public static void main(String[] args) {
		...
		// 시나리오] 정수10개를 저장할 수 있는 배열을 생성한후 반복문을 통해서 1부터 순차적인 값을 입력하시오.
...
//		}
		...
		/*
		 * 시나리오] 정수 5개를 저장할수 있는 배열을 생성한 후 숫자를 입력받아 저장한다. 단 숫자가 짝수일때만 저장할수있도록 프로그램을
		 * 작성하시오.
		 */
...
//		System.out.print(" ");
		/*
		 * 시나리오] 정수 5개를 저장할수 있는 배열을 생성한 후 숫자를 입력받아 저장한다. 단 숫자가 짝수일때만 순서대로 저장하고,
...
//		}
	...
	public static void randomCreate(int[] arr) {
		//1. 먼저 난수6를 생성한다. 임시배열에 저장한다.
		//랜덤 및 for문사용 //무한루프돌리기 true를 반복할때까지 
		
		//2. 배열에 저장된 값이 중복되어있는지 확인한다.(arrayExistElements(호출))
		
		//3. 중복된 값이 만약 있다면 1번으로 돌아가서 다시 난수를 생성한다.
		
		//4. 중복된 값이 없다면 lottoNum 배열에 채워준다.
	}
