	...
	public static void main(String[] args) {
		...
		*/
		...
		1-1] 객체저장 : add()메소드
			...
			부여한다.
			add(인덱스, 객체) : 인덱스를 직접 부여하는 객체를 저장한다.
...
//		list.add(5, "소방챀ㅋㅋㅋ");// 에러발생(인덱스를 건너뛸수 없다)
		...
		/*
		1-3] 리스트 컬렉션 출력하기(일반 for, 확장 for문)
		...
		/*
		Iterator 사용법
		1.컬렉션에 저장된 내용을 Iterator에 알려주기 위해 객체를
			생성한다.
		...
		1-6] 포함여부확인
			contains(객체) : 찾고자 하는 객체가 있는경우 true를
				반환한다. 위치한 인덱스까지 확인할 수 없다.
		 */
		System.out.println(list.contains("빅뱅") ? "빅뱅 있음" : "빅뱅 없음");
		System.out.println(list.contains("블랙핑크") ? "블랭핑크 있음" : "블랙핑크없음");
