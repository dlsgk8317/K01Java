...
/*
equals() 메소드
- 자바에서 인스턴스의 내용비교를 위해 비교연산자(==)르ㅡㄹ 사용하는것은
	단순히 참조값에 대한비교이므로 실제 내용에 대한 비교는
	이뤄지지 않는다.
- 인스턴스간의 내용비교를 위해서는 equals()메소드를 각 클래스에 맞게
	오버라이딩하여 사용해야한다.
- String과 같은 기본클래스는 별도로 오버라이딩 없이도 내용비교가 
	가능하다.
 */
...
public class E04Object2MyEquals {
	...
	public static void main(String[] args) {
		...
		String str1 = new String("우리KOSMO");
		String str2 = "우리KOSMO";
