...
//		System.out.println(Integer.parseInt(floatString)); // -> 에러발생
		...
		/*
		isLetter() : 문자인지 여부를 판단하는 메소드로 특수기호나 숫자형은
			false를 반환한다.
		 */
		 ...
		 */
		System.out.println("isWhisespace() 메소드로 공백문자 판단");
		...
		시나리오] 주어진 문자열안에 몇개의 공백문자(스페이스)가 있는지 판단하는 
			프로그램을 작성하시오.
			참고] toCharArry(() : 문자열을 char형 배열로 반환해주는
				String클래스에 정의된 메소드.
		 */
		...
		System.out.println("총곡백수=" + whiteCount);
	}
