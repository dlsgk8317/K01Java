...
-이와 같은 내부클래스를 static으로 선언하면 내부정적클래스(Nested)클래스라고 한다.
-정적 멤버변수, 정적 멤버베소드를 가질수 있다.
...
public class E02InnerStaticClass {
	...
	public static void main(String[] args) {
		...
		/*
		내부정적 클래스의 인스턴스형 멤버에 접근할때는 객체를 생성한 후 참조변수를 통해 접근해야한다.
		 */
		OuterClass.InnerStaticClass innerStaticClass = 
				new OuterClass.InnerStaticClass();
//				new OuterClas().InnerStaticClass(); // 에러발생
