...
작성방법
	...
	4. 위 방법을 통해 객체를 생성하면 메모리를 딱 하나만
	만들어지게된다.
 */
class NoSingleTone{
	int insVar;
...
public class E03SingleToneDesignPattern {
	...
	public static void main(String[] args) {
		...
		/*
		일반적인 방식의 객체생성이므로 객체를 생성할떄 새로운 참조값(주소값)을 할당받는
		인스턴스가된다.
		 */
