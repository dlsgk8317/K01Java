...
static 블럭
	...
	단, 다른 클래스에 main이 잇는 경우에는 main이 순차적으로
...
public class StaticBlock {
	...
	static {
		...
		/*
		블럭내에서만 사용할 수 있는 변수로써, 블럭내에서 일반적인 변수를 생성할 수 있다.
		 */
		int localVar;
		localVar = 1000;
...
//		instanceMethod();//에러발생
	...
	생성자를 통해 생성되기전에 static블럭이 먼저실행된다. 	
	 */
	public StaticBlock() {
			staticVar = -1;
	...
	/*
	main메소드가 외부파일에 잇을경우 태스트를 위해 아래부분을 주석처리 후 실행해본다.
	E02예제를 실행하면 된다.
	 */
