...
/*
접근지정자를 생략하였으므로 default클래스로 지정된다.
이 경우 동일한 패키지내에서만 접근할 수 없다.
 */
class DefaultClass1 {
...
/*
 ...
 동일해야하고, 다른 패키지에서도 접근할 수 없다. public클래스는
 하나의 자바파일에 단 하나만 정의할 수 있다.
 */
public class E01AccessModifier1 {
	
	/*
	멤버변수를 각각 접근지정자를 통해 선언한다.
	 */
	...
	즉 동일 클래스 내에서 접근지정자의 영향을 받지 않는다.
	 */
	...
	접근하고 싶을때는 public으로 선언된 멤버메소드를 이용하여
	간접적으로 접근할 수 있다.
	 */
