...
public class E04DoWhile { 
	...
	public static void main(String[] args)  throws IOException { 
		...
		/*
		시나리오] E03 예제으 수열문제를 do~while문으로 변경하여 
			구현하시오.
		 */
		...
		/*
		시나리오 ] 1~1000까지의 정수중 4의배수이거나 7의 배수인 수의 합을 구하여 
		...
		출력하는 프로그램을 작성하시오. 단, 사용자가 X,x(대소문자 구분없음)를 입력하면 프로그램이 
		...
		do {
			...
			/*
			while문은 if문과 같은 조건식을 사용할 수 없고 산술식만 사용할수 있으므로 점수의 구간을 구하기 위해 총점을 30으로 나눠준다.
			 */
