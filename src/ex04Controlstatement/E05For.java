...
for문 : while문과 같은 반복문으로 초기값, 조건식, 증감식이 한줄에 있어 반복의 횟수를 
	...
	형식] 
		...
		실행순서]
		초기값 -> 조건식확인 -> 참일때 실행 -> 증감식 -> 조건식확인 -> 반복문실행
			-> 조건이 거짓일때 for문 탈출
 */
...
public class E05For {
	...
	public static void main(String[] args) {
		...
		/*
		for문으로 무한루프를 만들때 사용. 일반적으로 while을 사용함.
		 */
		...
		*/
		...
		/*
		for문의 초기값을 외부(넓은지역)에서 선언하면 해당변수는 for문안쪽(좁은지역)에서 
		사용할 수 있다. 즉 아래에 선언한 변수 i는 main 메소드의 지역변수가 된다.
		 */
