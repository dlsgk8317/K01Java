...
public class E07RideAndLoad01 {
	...
	public static void main(String[] args) {
		...
		ref1.rideMethod();//C에(실행O)
		ref2.rideMethod();//정의된(실행O)
		ref3.rideMethod();//메소드 호출(실행O)
...
//		C refId3 = refId1; // C타입 = A타입 -> 불가능(에러발생)
		...
		double b= 20.2; //가능
		double c = 11; //가능
		int d = (int)20.2; //불가능해서 int형으로 강제 형변환
		 */
	}
