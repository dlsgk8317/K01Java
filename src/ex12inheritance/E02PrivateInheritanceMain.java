...
class Account {
	...
	/*
	입금처리 : protectedㄹ 선언되었으므로 상속관계에서 접근이가능하다.
	 */
...
class SavingAccount extends Account {
	...
	/*
	인자생성에서 부모 생성자 메소드를 호출하기위해 super()를
	...
	public void showAccountMoney() {
		 ...
		 */
		System.out.println("지금까지의 누적금액은" + getAccMoney());
	}
}
...
public class E02PrivateInheritanceMain {
	...
	public static void main(String[] args) {
		...
		/*
		private멤버이므로 상속받은 하위클래스의 차조변수를 통해서는
...
//		sa.money = 10000;//[접근불가]
		...
		현재 접근하는 위치가 Account클래스 외부이기 때문이다.ㅣ
		 */
		new Account(1000);
