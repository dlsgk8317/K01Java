...
/*
컴퓨터를 표현 : 기본적인 컴퓨터 환경을 제공하여 입력된 내용을
	계산한다.
 */
class Computer {
	String owner; //컴퓨터의 소유주 이름
	
//	public Computer() {} // 디폴트 기본생성자
	/*
	...
	상속받은 클래스에서 접근이 불가능하므로, public으로 선언딘
	메소드를 통해서 간접 호출해야한다.
...
class NotebookComputer extends Computer {
	...
	public void movigCal() {
		...
		/*
		private로 선언된 멤버메소드 이므로 직접 호출은 불가능하다.
		 */
//		keyboardTouch(); //에러발생
//		calculate(); //에러발생
		calculateFunc();
...
//	테블릿 사용을 위한 베터리양 체크 및 등록된 펜인지 확인
